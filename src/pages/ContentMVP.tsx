...
function ContentCard({ post }: { post: CreatorPost }) {
  return (
    <a
      ...
      className="group flex cursor-pointer flex-col rounded-xl border border-[var(--neutral-200)] bg-white text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[var(--brand-300)] hover:shadow-lg"
    >
      {/* Thumbnail — uniform 4:5 aspect for all content types */}
      <div className="relative w-full overflow-hidden rounded-t-xl bg-[var(--neutral-100)] aspect-[4/5]">
        <img
      ...
      <div className="flex flex-col gap-2 px-3 py-3">
        ...
        {/* Caption — up to 3 lines, row height adjusts per row */}
        <p
...
export default function ContentMVP() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Uniform grid — all cards same width + 4:5 thumbnails */}
